...
CREATE TABLE DEPLOYZ.DEPLOY (
    ...
    ZOAU_VERSION VARCHAR(50),
    SMF_RECORD_STATUS VARCHAR(50),
...
COMMENT ON COLUMN DEPLOYZ.DEPLOY.ARTIFACT_PATH IS 'Full path to the artifact';
...
COMMENT ON VIEW DEPLOYZ.V_ARTIFACT_USAGE IS 'Shows each artifact and how many steps use it';
...
COMMENT ON VIEW DEPLOYZ.V_DEPLOYMENT_HIERARCHY IS 'Complete hierarchy of deployments, activities, actions, and steps';
...
COMMENT ON VIEW DEPLOYZ.V_STEP_ARTIFACTS IS 'Shows which artifacts are used by which steps';
