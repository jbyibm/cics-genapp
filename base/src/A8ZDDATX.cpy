      *>****************************************************************A8ZDDATX
      *> LINKAGE SFDB05 : Gestion des dates BATCH                       A8ZDDATX
      *>----------------------------------------------------------------A8ZDDATX
      *CONTROL NOSOURCE                                                 A8ZDDATX
      *> Zone de communication module Gestion des Dates                 A8ZDDATX
      *> Confer TMR 11 0068                                             A8ZDDATX
      *> - Module batch : SFDB05                                        A8ZDDATX
      *>   call 'SFDB05' using ZS00 end-call                            A8ZDDATX
      *>----------------------------------------------------------------A8ZDDATX
      *> Paramètres obligatoires :                                      A8ZDDATX
      *> - Néant                                                        A8ZDDATX
      *> Paramètres facultatifs (selon contexte) :                      A8ZDDATX
      *> - leading ZS : préfixe des zones du service                    A8ZDDATX
      *>----------------------------------------------------------------A8ZDDATX
      *> MOT CLES :                                                     A8ZDDATX
      *>                                                                A8ZDDATX
      *>----------------------------------------------------------------A8ZDDATX
      *CONTROL SOURCE                                                   A8ZDDATX
      *> Utilisation :                                                  A8ZDDATX
      *> copy A8ZDDATX replacing leading ==ZS== by ==prefix==.          A8ZDDATX
      *>****************************************************************A8ZDDATX
      *>#GN 07/10/2024 10:51:38 BIB:CTRS.SFO SESSION:5498  USER:USER    A8ZDDATX
       01               ZS00.                                           A8ZDDATX
      *>-------------------------------------------------- #SEG:ZS1A ---A8ZDDATX
      *> Zone comm. Gestion des dates (In)                              A8ZDDATX
           02           ZS1A.                                           A8ZDDATX
      ...
      *>-------------------------------------------------- #SEG:ZS1B ---A8ZDDATX
      *> Zone comm. Gestion des dates (Out)                             A8ZDDATX
           02           ZS1B.                                           A8ZDDATX
